...
Lastly, while our analysis mainly handles utilization tracking, it is also possible to model a simple linear resources such as a file handler. With more works, the utilization value and effect annotation could potentially be generalized to include the other substructural type system, such as the linear and affine types. An algebra of the utilization values and effect may also be defined to notate more specific cases.
